...
SELECT 
	...
	ROUND(SUM(oi.total_sale::numeric),2) 
			as total_sale
FROM orders as o
JOIN
order_items as oi
...
SELECT 
	...
	cat.category_name,
	SUM(oi.total_sale) as total_sale,
	DENSE_RANK() OVER(PARTITION BY c.state ORDER BY SUM(oi.total_sale) ASC) as rank
FROM orders as o
JOIN 
customers as c
ON o.customer_id = c.customer_id
...
/*
9. Shipping Delays
Identify orders where the shipping date is 3 or more days after the order date.
...
-- checking stock and product availability in inventory	
	...
	-- update inventory
		...
		RAISE NOTICE 'Thank you, product: % sale has been added, also the inventory stock updated',v_product; 
